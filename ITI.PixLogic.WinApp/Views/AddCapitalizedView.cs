...
namespace ITI.PixLogic.WinApp
{
	public partial class AddCapitalizedView : Form
	{
		...
		private void InvoiceComboBox_Click( object sender, EventArgs e )
		{
			...
			InvoiceComboBox.ValueMember = "PhaseNumber";
		...
		private void AddBtn_Click( object sender, EventArgs e )
		{
			...
			for( int j = 0; j < 7 - 1; j++ )
			{
				_capitalizedViewMain.CapitalizedDataListView.AutoResizeColumn( j, ColumnHeaderAutoResizeStyle.ColumnContent );
				_capitalizedViewMain.CapitalizedDataListView.AutoResizeColumn( j, ColumnHeaderAutoResizeStyle.HeaderSize );
			}

			for( int a = 7; a < 14 - 1; a++ )
			{
				_capitalizedViewMain.CapitalizedDataListView.AutoResizeColumn( a, ColumnHeaderAutoResizeStyle.ColumnContent );
				_capitalizedViewMain.CapitalizedDataListView.AutoResizeColumn( a, ColumnHeaderAutoResizeStyle.HeaderSize );
			}
