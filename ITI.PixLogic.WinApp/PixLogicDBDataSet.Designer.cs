...
namespace ITI.PixLogic.WinApp {
    ...
    public partial class PixLogicDBDataSet : global::System.Data.DataSet {
        ...
        public partial class ItemsDataTable : global::System.Data.TypedTableBase<ItemsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ItemsRow AddItemsRow(uint Id, uint EAN13, string Reference, uint ReservationCost, bool Consumable, bool Reservable, uint Brand, uint SubCategory, uint CurrentState) {
...
namespace ITI.PixLogic.WinApp.PixLogicDBDataSetTableAdapters {
    ...
    public partial class ItemsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `pixlogicdb`.`items` WHERE ((`Id` = @p1) AND ((@p2 = 1 AND `EAN13` IS NULL) OR (`EAN13` = @p3)) AND (`Reference` = @p4) AND (`ReservationCost` = @p5) AND (`Consumable` = @p6) AND (`Reservable` = @p7) AND (`Brand` = @p8) AND (`SubCategory` = @p9) AND (`CurrentState` = @p10))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `pixlogicdb`.`items` SET `EAN13` = @p1, `Reference` = @p2, `ReservationCost` = @p3, `Consumable` = @p4, `Reservable` = @p5, `Brand` = @p6, `SubCategory` = @p7, `CurrentState` = @p8 WHERE ((`Id` = @p9) AND ((@p10 = 1 AND `EAN13` IS NULL) OR (`EAN13` = @p11)) AND (`Reference` = @p12) AND (`ReservationCost` = @p13) AND (`Consumable` = @p14) AND (`Reservable` = @p15) AND (`Brand` = @p16) AND (`SubCategory` = @p17) AND (`CurrentState` = @p18))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `Id`, `EAN13`, `Reference`, `ReservationCost`, `Consumable`, `Reservable`," +
                " `Brand`, `SubCategory`, `CurrentState` FROM `Items`";
        ...
        public virtual int Delete(uint p1, global::System.Nullable<uint> p3, string p4, uint p5, byte p6, byte p7, uint p8, uint p9, uint p10) {
